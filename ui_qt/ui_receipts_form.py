...
# Form implementation generated from reading ui file 'from_designer/receipts_form.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Список сделок"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Дата"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Покупатель"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Продавец"))
