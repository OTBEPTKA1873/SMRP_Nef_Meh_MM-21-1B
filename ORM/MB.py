...
class MB(Base):
    ...
    MB_name = Column(String(63), primary_key=True, nullable=False)
    ...
    def __str__(self):
        return f"MB {self.MB_name} {self.form_factor} {self.socket_type} {self.RAM_type} {self.RAM_count} {self.freq} {self.GPU_type}"
